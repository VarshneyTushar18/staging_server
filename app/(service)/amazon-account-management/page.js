...
export const metadata = {
    ...
    openGraph: {
        ...
        description:
            "Our Amazon account management services concentrate on simplifying and managing processes and optimizing your account for increased product revenue.",
        url: "https://stagenew.tech2globe.tech/amazon-account-management",
        type: "website",
    },
    twitter: {
    ...
    alternates: {
        canonical: "https://stagenew.tech2globe.tech/amazon-account-management",
    },
};
...
const portfolioClients = [
    {
        ...
        desc: "US tech accessories brand that achieved 65% revenue growth by fully outsourcing Seller Central management including PPC, listings, and account health.",
    ...
    },
    {
        ...
        desc: "Austrian lifestyle brand that has relied on Tech2Globe for 18 months of seamless full-account Amazon management with consistent weekly reporting.",
        category: "Account Management",
    ...
    },
    {
        ...
        desc: "Ghanaian crafts brand that scaled from $10K to $45K monthly Amazon revenue with proactive account management and policy compliance monitoring.",
        category: "Account Management",
