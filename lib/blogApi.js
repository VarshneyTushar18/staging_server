import { blogPostHref, stripHtml } from "./blogUtils.js";

const API = process.env.NEXT_PUBLIC_API_URL || "http://localhost:5000";
const SITE =
  process.env.NEXT_PUBLIC_SITE_URL || "https://stagenew.tech2globe.tech";

export const DEFAULT_BLOG_IMAGE = "/images/blog-bg.webp";

/** Return the first usable featured image supplied by either API response shape. */
